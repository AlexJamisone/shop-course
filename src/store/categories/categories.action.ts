...
export type FetchCategoriesSuccess = 
    ActionWithPayload<CATEGORIES_ACTION.FETCH_CATEGORIES_SUCCESS, Category[]>
export type FetchCategoriesFaild = 
    ActionWithPayload<CATEGORIES_ACTION.FETCH_CATEGORIES_FAILED, Error>


export type CategoryAction = FetchCategoriesStart | FetchCategoriesSuccess | FetchCategoriesFaild
...
export const fetchCategoriesFailed = (error: Error): FetchCategoriesFaild => 
